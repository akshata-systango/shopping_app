        ...
        <React.Fragment>
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div >
                    ...
                    <div className="vector1" onClick={props.onShow}>
                        <div className="cart"><img src={cartImage} alt="can't load" />
                            <span className="itemCount"> {numberOfCartItems}</span></div>
                    </div>

                    {/* searching item */}
                    <div className="vector2"><img src={searchImage} onClick={searchHandler} alt="can't load" />
                        {showInput &&
